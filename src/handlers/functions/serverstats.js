...
module.exports = async (client) => {
    ...
    client.on(Discord.Events.GuildRoleCreate, async role => client.emit('updateRoles', role.guild))
    client.on(Discord.Events.GuildRoleDelete, async role => client.emit('updateRoles', role.guild))
    ...
    client.on(Discord.Events.ClientReady, async client => {
        ...
        client.emit('updateOnline');
        client.emit('updateBoosts');
    })
}
