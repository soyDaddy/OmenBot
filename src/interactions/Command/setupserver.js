...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('setupserver')
        .setDescription('Configura un servidor por completo con 1 solo click')
        .addStringOption((option) => option.setName("tipo").setDescription("Que tipo de configuración quieres?").setRequired(true)
        .addChoices(
            { name: "Básica", value: "basic" },
            { name: "Avanzada", value: "advanced" },
    ...
    run: async (client, interaction, args) => {
        const setup = interaction.options.getString("tipo");
        ...
        switch (setup) {
            case "basic": {
                ...
                const basicEmbed = new EmbedBuilder()
                    .setColor("Orange")
                    .setTitle("⚠️ Alerta de Creación de Servidor ⚠️")
                    .setDescription("Haciendo click en el botón de ✅Confirmar todos los canales y categorías serán eliminados y reemplazados por la plantilla que has escogido.\n\n**NO HAY OPCIÓN DE DESHACER!**")
                    .setTimestamp()
                    .setFooter({ text: "ADVERTENCIA" });
                ...
                collector.on("collect", async (i) => {
                    ...
                    if (i.customId === "button1") {
                        ...
                        basicEmbed.setTitle("Configuración del Servidor Cancelada");
                        basicEmbed.setDescription("La configuración automatica del servidor ha sido cancelada, si quiere volver a realizar la acción deverás volver a ejecutar el comando.");
                    ...
                    if (i.customId === "button2") {
                        ...
                        basicEmbed.setTitle("Iniciando...");
                        basicEmbed.setDescription("La configuración empezará dentro de poco. Ten paciencia, está accion puede tardar de 2 a 5 minutos.");
                        basicEmbed.setTimestamp();
            ...
            case "advanced": {
                ...
                advancedcollector.on("collect", async (i) => {
                    ...
                    if (i.customId === "button3") {
                        ...
                        advancedembed.setTitle("Configuración Cancelada");
                        advancedembed.setDescription("La configuración automatica del servidor ha sido cancelada, si quiere volver a realizar la acción deverás volver a ejecutar el comando.");
                    ...
                    if (i.customId === "button4") {
                        ...
                        advancedembed.setTitle("Iniciando...");
                        advancedembed.setDescription("La configuración del servidor Avanzado, empezará dentro de poco.\nTen paciencia, este porceso puede tardar de 2 a 5 minutos.");
                        advancedembed.setTimestamp();
                        await i.update({ embeds: [advancedembed], components: [] });
                        await new Promise((resolve) => setTimeout(resolve, 5000));
                    }
...
---------------------------------------------------------*/
            ...
            case "premium": {
                ...
                if (i.customId === "button5") {
                    ...
                    premiumembed.setTitle("Configuración Cancelada");
                    premiumembed.setDescription("La configuración automática del servidor ha sido cancelada, si quieres volver a configurarlo, vuelve a ejecutar el comando.");
                ...
                if (i.customId === "button6") {
                    ...
                    premiumembed.setTitle("Iniciando...");
                    premiumembed.setDescription("La configuración del servidor Premium, empezará dentro de poco.\nTen paciencia, este porceso puede tardar de 2 a 5 minutos.");
                    premiumembed.setTimestamp();
                    await i.update({ embeds: [premiumembed], components: [] });
                    await new Promise((resolve) => setTimeout(resolve, 5000));
                };
