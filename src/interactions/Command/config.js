...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand => subcommand
            ...
            .addStringOption(option => option
                .setName("name")
                .setDescription("Enter a name for the channel or send HELP for the args")
                .setRequired(true)
            )
        )
        .addSubcommand(subcommand => subcommand
            ...
            .addStringOption(option => option
                .setName("message")
                .setDescription("Enter a message for the levels or send HELP for the args")
                .setRequired(true)
            )
        )
        .addSubcommand(subcommand => subcommand
            ...
            .addStringOption(option => option
                .setName("image")
                .setDescription("Enter a welcome image")
                .setRequired(false)
            )
        )
        .addSubcommand(subcommand => subcommand
