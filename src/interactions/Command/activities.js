...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('activities')
        .setDescription(global.i18n.getMessage(null, `commands.slash.activities.description`))
        .setNameLocalizations(global.i18n.getAllMessages(`commands.slash.activities.name`))
        .setDescriptionLocalizations(global.i18n.getAllMessages(`commands.slash.activities.description`))
        .addStringOption(option => option
            .setName('activity')
            .setDescription(global.i18n.getMessage(null, `commands.slash.activities.activity.description`))
            .setNameLocalizations(global.i18n.getAllMessages(`commands.slash.activities.activity.name`))
            .setDescriptionLocalizations(global.i18n.getAllMessages(`commands.slash.activities.activity.description`))
            .setRequired(true)
            .addChoices(
