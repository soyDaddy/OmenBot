...
module.exports = async (client, interaction, args) => {
    ...
    if (data) {
        ...
        client.embed({
            title: `${client.emotes.normal.error}・Sugerencia Denegada`,
        ...
        try {
            ...
            if (user) {
                client.embed({
                    title: `${client.emotes.normal.check}・Sugerencia Denegada`,
                    desc: `Tu sugerencia enviada en ${interaction.guild.name} a sido denegada por un Moderador!`,
                    fields: [
                        {
                            name: `💬┆Sugerencia`,
        ...
        client.succNormal({
            text: "Sugerencia denegada correctamente",
            fields: [
                {
                    name: `💬┆Sugerencia`,
                    value: `${embedData.description}`
